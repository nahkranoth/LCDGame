...
if __name__=="__main__":
    ...
    create_char(0,custom_char)
    bus.write_byte_data(DISPLAY_TEXT_ADDR, 0x80, 0x80) # Very important to issue this after setting a custom character
    textCommand(0xc0)  # next line
    bus.write_byte_data(DISPLAY_TEXT_ADDR, 0x40, 0x20)
    bus.write_byte_data(DISPLAY_TEXT_ADDR, 0x40, 0x00)
